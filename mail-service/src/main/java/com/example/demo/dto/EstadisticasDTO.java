...
public class EstadisticasDTO {
    ...
    private List<Map<String, Object>> motivosRechazo;
    ...
    public List<Map<String, Object>> getMotivosRechazo() {
        return motivosRechazo;
    }

    public void setMotivosRechazo(List<Map<String, Object>> motivosRechazo) {
